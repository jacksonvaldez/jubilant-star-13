...
RSpec.describe 'Hospital Show Page' do
  ...
  before(:each) do
    ...
    @doctor_2 = Doctor.create!(name: 'Doctor Doctor', specialty: 'Optical Surgery', university: 'Stanford university', hospital_id: @hospital_1.id)
    @doctor_3 = Doctor.create!(name: 'Doctor Jenner', specialty: 'Brain Surgery', university: 'Harvard university', hospital_id: @hospital_1.id)
    @doctor_4 = Doctor.create!(name: 'Doctor Hash', specialty: 'Doctor Stuff', university: 'Some university', hospital_id: @hospital_2.id)
  ...
  it 'displays a unique list of universities that this hospitals doctors attended' do
    expect(page).to have_content("Stanford university").once
    expect(page).to have_content("Harvard university").once
